...
Нужен `X-Project-Token`. Удаляет текущего пользователя из участников проекта. Если пользователь последний админ, а в проекте есть другие участники, сначала нужно назначить другого админа.
